...
// 为了向后兼容，导出全局函数
export function createOneEuroFilter(freq, minCutoff, beta, dCutoff) {
    const config = {};
    if (freq !== undefined)
