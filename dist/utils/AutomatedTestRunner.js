...
export class AutomatedTestRunner {
     ...
     * 检查性能基准
     */
    checkBenchmark(value, benchmark) {
    ...
    exportReport(results) {
        const report = {
            ...
            summary: {
                ...
                passedTests: Array.from(results.values()).reduce((sum, suite) => sum + Array.from(suite.values()).filter(r => r.passed).length, 0)
            },
            suites: Object.fromEntries(Array.from(results.entries()).map(([name, suiteResults]) => [
                name,
...
//# sourceMappingURL=AutomatedTestRunner.js.map