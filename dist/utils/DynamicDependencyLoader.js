...
export class DynamicDependencyLoader {
    ...
    isDependenciesLoaded() {
        const tfLoaded = typeof window.tf !== 'undefined';
        const poseDetectionLoaded = typeof window.poseDetection !== 'undefined';
     ...
     */
    async loadDependencies(options = {}) {
        // 如果已经加载，直接返回
     ...
     * 加载脚本 - 修复：按正确顺序加载依赖
     */
    async loadScripts(dependencies, timeout) {
    ...
    async validateDependencies() {
        ...
        try {
            await window.tf.ready();
            console.log('📦 TensorFlow.js 版本:', window.tf.version.tfjs);
        }
        catch (error) {
...
DynamicDependencyLoader.instance = null;
// 导出单例实例
export const dynamicDependencyLoader = DynamicDependencyLoader.getInstance();
//# sourceMappingURL=DynamicDependencyLoader.js.map