...
function demonstrateBasicUsage() {
    ...
    timestamps.forEach((timestamp) => {
        ...
        console.log(`${timestamp}ms\t${noisyValue.toFixed(2)}\t\t${filteredValue.toFixed(2)}\t\t${noiseReduction > 0 ? '+' : ''}${noiseReduction.toFixed(2)}`);
    });
    console.log('\n');
}
/**
...
export { demonstrateBasicUsage, demonstrateManagerUsage, demonstratePresets, demonstrateConfigManagement, performanceTest, runDemo };
//# sourceMappingURL=OneEuroFilterDemo.js.map