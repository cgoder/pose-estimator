 ...
 * 异步加载统一依赖配置
 */
async function loadUnifiedDependencyConfig() {
    try {
        // 首先加载统一依赖配置文件（使用相对路径）
 ...
 * 安全的依赖加载函数 - 使用统一配置
 */
async function loadDependenciesSafely() {
 ...
 * 加载姿态估计模型
 */
async function loadPoseModel(modelTypeParam, config = {}) {
...
//# sourceMappingURL=pose-worker-simple.js.map